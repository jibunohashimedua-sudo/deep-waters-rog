 ...
 * is waiting, and then it is gone. Nothing spins, nothing pulses, and
 * there is no stack of grey blocks pretending to be the content that has
 * not arrived — a stand-in is a guess about a layout, and when the guess
 * is wrong the page jumps twice instead of once.
 *
